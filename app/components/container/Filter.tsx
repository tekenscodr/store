        ...
        <div className='relative'>
            <div className={`md:w-[250px] border-l-[0.5px] border-r-[0.5px] ${showFilter ? "max-md:w-[250px]":"w-0 max-md:invisible"}`}>
                ...
                <div className='flex flex-col py-3 pb-5 tet-sm text-neutral-600 border-b-[0.5px]'>
                    <span
                        className={`py-3 px-5 ${selectedCategories.includes('Blouses') ? "bg-blue-50":""}`}
                        onClick={() => toggleCategory('Blouses')}
                    >
                        Blouses
                    </span>
                    <span
                        className={`py-3 px-5 ${selectedCategories.includes('Shirt') ? "bg-blue-50":""}`}
                        onClick={() => toggleCategory('Shirt')}
                    >
                        Shirt
                    </span>
                    <span 
                    className={`py-3 px-5 ${selectedCategories.includes('Denim&Jeans') ? 'bg-blue-50' : ''}`}
                    onClick={() => toggleCategory('Denim&Jeans')}
                    >
                        Denim&Jeans
                    </span>
                    <span 
                        className={`py-3 px-5 ${selectedCategories.includes('Party') ? 'bg-blue-50' : ''}`}
                        onClick={() => toggleCategory('Party')}
                    >
                    Party
                    </span>
                    <span 
                        className={`py-3 px-5 ${selectedCategories.includes('Pants') ? 'bg-blue-50' : ''}`}
                        onClick={() => toggleCategory('Pants')}
                    >
                        Pants
                    </span>
                    <span 
                        className={`py-3 px-5 ${selectedCategories.includes('Skirts') ? 'bg-blue-50' : ''}`}
                        onClick={() => toggleCategory('Skirts')}
                    >
                        Skirts
                    </span>
                    <span 
                        className={`py-3 px-5 ${selectedCategories.includes('Tops&tees') ? 'bg-blue-50' : ''}`}
                        onClick={() => toggleCategory('Tops&tees')}
                    >
                        Tops&tees
                    </span>
                    <span 
                        className={`py-3 px-5 ${selectedCategories.includes('Jackets&Coats') ? 'bg-blue-50' : ''}`}
